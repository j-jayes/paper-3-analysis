...
# load the data
df <- read_rds(here::here("replication-data", "figure-1.rds"))

jpeg(here::here("replication-figures", "Figure-1.png"),
...
```{r}
df <- read_rds(here::here("replication-data", "figure-2.rds"))
...
ggsave(filename = here::here("replication-figures", "Figure-2.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)
```
...
```{r}
figure_3_data <- read_rds(here::here("replication-data", "figure-3.rds"))
...
ggsave(filename = here::here("replication-figures", "Figure-3_1.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)
...
ggsave(filename = here::here("replication-figures", "Figure-3_2.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)


library(magick)

# Read the images
image1 <- image_read(here::here("replication-figures", "Figure-3_1.png"))
image2 <- image_read(here::here("replication-figures", "Figure-3_2.png"))

# Combine images side by side
combined_image <- image_append(c(image2, image1), stack = FALSE)

# Save the combined image
image_write(combined_image, here::here("replication-figures", "Figure-3.png"))
```

Figure 4

```{r}
df <- read_rds(here::here("replication-data", "figure-4.rds"))
...
ggsave(filename = here::here("replication-figures", "Figure-4.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)
```
...
```{r}
df = read_rds(here::here("replication-data", "figure-5.rds"))
...
ggsave(filename = here::here("replication-figures", "Figure-5.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)
```
...
df = read_rds(here::here("replication-data", "Figure-6.rds"))
...
ggsave(filename = here::here("replication-figures", "Figure-6.png"), device = "png", width = 290, height = 231, units = "mm", dpi = 300)
```
...
```{r}
df = read_rds(here::here("replication-data", "figure-7.rds"))
