...
summarize birth_parish_distance_to_line, d

histogram birth_parish_distance_to_line

binscatter log_income birth_parish_distance_to_line, linetype(qfit) nq(200)

* Model 3: Extending Model 2 by adding marital status, schooling, and hisclass

reg log_income birth_parish_distance_to_line age age_2 female i.marital i.schooling i.hisclass, vce(cluster birth_parish_ref_code)
eststo Model1

* Tabulate the regression results and save them in TeX format
esttab Model1 using $results_dir/12-distances-log-income-regression.tex, label replace ///
...
gen birth_parish_distance_to_line_2 = birth_parish_distance_to_line*birth_parish_distance_to_line

  
reg log_income birth_parish_distance_to_line birth_parish_distance_to_line_2 age age_2 female i.marital i.schooling i.hisclass, vce(cluster birth_parish_ref_code)

  
  
twoway lowess log_income birth_parish_distance_to_line 
