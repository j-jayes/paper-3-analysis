...
use "data/first-stage/first_stage_data_with_union_density.dta"
...
*---------------------------------------------------*
* Regression Analyses for union density
*---------------------------------------------------*

local distance_cutoff = 300


reg union_density_1900 treated area latitude longitude if distance_to_line < `distance_cutoff'

reg union_density_1910 treated area latitude longitude if distance_to_line < `distance_cutoff'

reg union_density_1930 treated area latitude longitude if distance_to_line < `distance_cutoff'
