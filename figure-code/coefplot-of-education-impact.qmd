...
coeff_data %>% write_rds(here::here("replication-data", "figure-7.rds"))
...
ggplot(df, aes(y = variable, x = coefficient)) +
  ...
  theme_minimal() +
  labs(x = "Magnitude of Regression Coefficient for\nVariable Interacted with Western Line Birth Parish", y = "Variable Interacted with Western Line Birth Parish") +
  theme(
