...
exclude_touching = False  # set to False if you do not want to exclude parishes touching treatment group
source_type = None  # set to 'water', 'steam', 'transmitted', or None
